...
public final class Researches {
    ...
    public static void setup() {
        ...
        create(3, "infinity_ingot", "无尽锭的制作方式", 100,
        ...
        create(13, "advanced_machines", "进阶机器", 60,
        ...
        create(14, "upgraded_machines", "升级机器", 60,
        ...
        create(15, "infinity_upgrades", "无尽升级", 120,
